const Card = () => {
  return (
    <div className="w-[21.875rem] flex flex-col gap-y-[3.75rem] px-5 py-10 justify-center items-center border border-primary-1 rounded-[0.75rem] lg:w-[27rem]">
      <p className="button-lg text-neutral-3">mempo</p>
      <div className="flex flex-col gap-y-10 justify-center items-center">
        <div className="flex flex-col gap-y-5 justify-center items-center">
          <img src="/2.png" alt="1st mask picture" />
